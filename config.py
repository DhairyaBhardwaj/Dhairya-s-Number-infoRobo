...
APP_ID = int(os.environ.get("APP_ID", "22627587")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "4f664b2a2bf3b095a689a51780a45a5e") #Your API Hash from my.telegram.org
#--------------------------------------------
